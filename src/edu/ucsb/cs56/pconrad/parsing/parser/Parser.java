...
public class Parser {
    ...
    private ParseResult<Operator> parseComparisonExpression(final int pos) throws ParserException
    {
	final Token tokenHere = tokenAt(pos);
	if (tokenHere.equals(LESSTHAN_TOKEN)) {
	    ...
	    throw new ParserException("Expected comparison operator");
	}
    }
	...
	if(tokenHere.equals(EXPONENT_TOKEN)){
	    ...
	    throw new ParserException("Expected exponent operator");
	}
    }
    ...
    private class ParseComparitive extends ParseAdditiveOrMultiplicative {
	public ParseResult<AST> parseBase(final int pos) throws ParserException {
    ...
    private ParseResult<AST> parseComparitiveExpression(final int pos)
	throws ParserException {
